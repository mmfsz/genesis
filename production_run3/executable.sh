...
echo "Copy HIG-MiniAODv4_${CAMPAIGN}.root"
COPY_SRC="file://${PWD}/HIG-MiniAODv4_${CAMPAIGN}.root"
COPY_DEST="davs://redirector.t2.ucsd.edu:1095/${OUTDIR//NANO/MINI}/${OUTPUTNAME}_${IJOB}.root"
stageout $COPY_SRC $COPY_DEST

echo "Copy HIG-NanoAODv12_${CAMPAIGN}.root"
COPY_SRC="file://${PWD}/HIG-NanoAODv12_${CAMPAIGN}.root"
